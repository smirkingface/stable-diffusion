...
from sd.modules.encoder import Encoder, Decoder
from sd.modules.distributions import DiagonalGaussianDistribution

from sd.util import instantiate_from_config

class AutoencoderKL(pl.LightningModule):
    def __init__(self, ddconfig={}, embed_dim=4, lossconfig=None, image_key="image"):
        super().__init__()
        ...
        self.z_channels = self.decoder.z_shape[1]
